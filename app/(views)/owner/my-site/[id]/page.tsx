...
const ContactItems = dynamic(() => import('@/app/_components/ContactItems'), { ssr: false });
const MapLocationDisplay = dynamic(() => import('@/app/_components/MapLocationDisplay'), {
  ssr: false,
});
const ScheduleDisplay = dynamic(() => import('@/app/_components/ScheduleDisplay'), { ssr: false });
const SiteReviewCard = dynamic(() => import('@/app/_components/SiteReviewCard'), { ssr: false });
...
export default function SiteDetails({ params }: { params: { id: string } }) {
  ...
  const handleToEditSite = () => push(`/owner/my-site/${params.id}/edit`);
